...
public class Vttp5aDay11lApplication {
	...
	public static void main(String[] args) {
		...
		app.setDefaultProperties(Collections.singletonMap("server.port",port)); // whats this
		...
		//application.properties -> takes priority
	...
	public CommonsRequestLoggingFilter logging() {
		...
		crlf.setIncludeQueryString(true); // for sql for example
